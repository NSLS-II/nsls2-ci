...
message "pushd'ing into $TRAVIS_BUILD_DIR/`basename $TRAVIS_REPO_SLUG`/$DOCS_SOURCE_SUBDIR"
pushd $TRAIVS_BUILD_DIR/`basename $TRAVIS_REPO_SLUG`/$DOCS_SOURCE_SUBDIR
